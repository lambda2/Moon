...
function isNumTelephone($num){ return preg_match("#^0[1-68]([-. ]?[0-9]{2}){4}$#", htmlspecialchars($num)); }

function isEmailAdress($email){ return preg_match("#^[a-z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,4}$#", htmlspecialchars($email)); }
